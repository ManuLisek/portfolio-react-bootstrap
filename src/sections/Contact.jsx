                  ...
                  {({
                    ...
                    return (
                      <form method="POST" id="contactForm" name="contactForm" className="contactForm" noValidate="novalidate" onSubmit={handleSubmit} >
                        ...
                        {isFormSended
                          ? (isSubmitting
                            ? <div className="mb-4">Wysyłanie...</div>
                            : (isError
                              ? <div className="mb-4 text-danger">Uuups! Coś poszło nie tak...</div>
                              : <div className="mb-4">Twoja wiadomość została wysłana. Dziękuję!</div>))
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-12">
                            <div className="form-group">
                              <button type="submit" className="btn btn-primary" disabled={isSubmitting}>Wyślij wiadomość</button>
